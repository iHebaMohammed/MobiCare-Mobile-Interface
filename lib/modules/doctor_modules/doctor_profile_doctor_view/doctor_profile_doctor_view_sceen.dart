                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  'Dr. ${cubit.doctorProfileModel!.data!.fName} ${cubit.doctorProfileModel!.data!.lName}',
                                  style: TextStyle(
                                    color: primaryBlackColor,
                                    fontSize: 18,
                                    fontWeight: FontWeight.w500,
                                ...
                                Text(
                                  '${cubit.doctorProfileModel!.data!.specialization}',
                                  style: TextStyle(
                                    color: primaryBlackColor,
                                    fontSize: 14,
                                ...
                                if(cubit.doctorProfileModel!.data!.rate!.round() == 1)
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      ...
                                      Text(
                                        '${cubit.doctorProfileModel!.data!.rate}*',
                                        style: TextStyle(
                                      ...
                                      Text(
                                        '${cubit.doctorProfileModel!.data!.reviewsNo} Reviews',
                                        style: TextStyle(
                                ...
                                if(cubit.doctorProfileModel!.data!.rate!.round() == 2)
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      SvgPicture.asset('assets/icons/active_star.svg'),
                                ...
                                if(cubit.doctorProfileModel!.data!.rate!.round() == 3)
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      SvgPicture.asset('assets/icons/active_star.svg'),
                                ...
                                if(cubit.doctorProfileModel!.data!.rate!.round() == 4)
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      SvgPicture.asset('assets/icons/active_star.svg'),
                                ...
                                if(cubit.doctorProfileModel!.data!.rate!.round() == 5)
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      SvgPicture.asset('assets/icons/active_star.svg'),
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                Text(
                                                  '${cubit.doctorProfileModel!.data!.patientsNo}',
                                                  style: TextStyle(
                                                      fontSize: 28,
                                                      color: primaryBlackColor,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                Text(
                                                  '${cubit.doctorProfileModel!.data!.experince}yrs',
                                                  style: TextStyle(
                                                      fontSize: 30,
                                                      color: primaryBlackColor,
                                                      fontWeight: FontWeight.w500
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              SizedBox(width: 20,),
                              Text(
                                '${cubit.doctorProfileModel!.data!.dOB!}',
                                style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 16,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 20,),
                              Text(
                                '${cubit.doctorProfileModel!.data!.address!}',
                                style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 16,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 20,),
                              Text(
                                '${cubit.doctorProfileModel!.data!.email!}',
                                style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 16,
                                ),
                          ...
                          Row(
                            children: [
                              Icon(
                                cubit.doctorProfileModel!.data!.gender! == 0 ? Icons.female :Icons.male,
                                size: 28,
                                color: primaryColor1BA,
                              ),
                              SizedBox(width: 20,),
                              Text(
                                '${cubit.doctorProfileModel!.data!.gender! == 0 ? 'Female' : 'Male'}',
                                style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 16,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 20,),
                              Text(
                                '${cubit.doctorProfileModel!.data!.phone!}',
                                style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 16,
                                ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        cubit.doctorProfileModel!.data!.bio != null ? '${cubit.doctorProfileModel!.data!.bio.toString()}' : 'Write something about you',
                        style: TextStyle(
                          color: primaryBlackColor,
                          fontWeight: FontWeight.w300,
                          fontSize: 15,
